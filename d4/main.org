...
** Product Morphisms
   ...
   \end{align}
   \begin{align}
   \left( \left( X \xrightarrow{}  Y \right) \times X \right) \xrightarrow{\text{Eval}}  Y
   \end{align}
   :END:
...
** Initial & Terminal Object
   ...
   \end{align}
   \begin{align}
   \left( \left( U \xrightarrow{}  V \right) \times \left( U \xrightarrow{}  W \right) \right) \xmapsto[\infty]{\text{Prod}} \left( U \xrightarrow{}  \left( V \times W \right) \right)
   \end{align}
   \begin{align}
   ...
   fg.extractElement(y).lpretty.lwriteln;
   #+END_SRC
